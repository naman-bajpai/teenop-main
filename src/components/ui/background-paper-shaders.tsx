  ...
  return (
    <div className={cn("absolute inset-0 pointer-events-none", className)}>
      <Canvas camera={{ position: [0, 0, 3.5], fov: 55 }} dpr={[1, 1.5]}>
        ...
        <ShaderPlane position={[-0.7, 0.2, -0.4]} color1="#ff725a" color2="#ffffff" />
        <ShaderPlane position={[0.9, -0.35, -0.8]} color1="#96cbc3" color2="#ffffff" />
        <EnergyRing radius={0.75} position={[0.65, 0.45, 0.2]} />
        <EnergyRing radius={0.55} position={[-0.85, -0.3, 0.3]} />
      </Canvas>
    </div>
  )
}
