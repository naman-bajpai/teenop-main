  ...
  const fetchServiceDetails = async () => {
    try {
      ...
      const serviceData: Service = {
        ...data,
        provider_name: data.profiles ? `${data.profiles.first_name} ${data.profiles.last_name}` : null
      };
          ...
          {bookingSuccess && (
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-green-700 text-sm">The service provider will review your request and get back to you soon.</p>
              </div>
            </div>
          )}
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className={`relative h-64 bg-gradient-to-br ${gradient} flex items-center justify-center`}>
                  ...
                  <div className="relative text-9xl opacity-30">
                    {icon}
                  </div>
